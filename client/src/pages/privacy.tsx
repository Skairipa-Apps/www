            ...
            <div className="bg-white rounded-xl shadow-md p-8">
              <div id="privacy-policy-content" className="prose max-w-none">
                <p>
                  ...
                  personal information when you use our websites, mobile apps,
                ...
                <ul>
                  ...
                  <li>
                    <strong>Usage Data:</strong> Pages visited, app
                    interactions, device type, crash reports, and performance
                    analytics.
                  </li>
                  <li>
